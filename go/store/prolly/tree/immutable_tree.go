...
func NewImmutableTreeFromReader(ctx context.Context, r io.Reader, ns NodeStore) (*ImmutableTree, error) {
	s := message.ProllyMapSerializer{Pool: ns.Pool()}
	root, err := buildImmutableTree(ctx, r, ns, s, defaultFixedChunkLength)
